  ...
  return (
    <div className="flex flex-col gap-6 p-6 lg:p-8">
      ...
      <div>
        ...
        {isAdmin && (
          <div className="mt-3 bg-muted/30 px-3.5 py-2.5 text-sm text-muted-foreground">
      ...
      {/* Notifications — Admin/SrSci only */}
      {isReviewer && (
        <>
          <div>
      ...
      <div>
        ...
        >
          ...
          {pwError && (
            <div className="max-w-sm border border-destructive/20 bg-destructive/10 px-3.5 py-2.5 text-sm text-destructive">
              {pwError}
            </div>
          )}

          {pwSuccess && (
            <div className="max-w-sm border border-green-200 bg-green-50 px-3.5 py-2.5 text-sm text-green-700 dark:border-green-800/50 dark:bg-green-950/50 dark:text-green-300 flex items-center gap-2">
      ...
      {showConfirm && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50">
          <div className="mx-4 w-full max-w-md rounded-2xl border bg-card p-6 shadow-lg">
            ...
            {deleteError && (
              <div className="mt-3 border border-destructive/20 bg-destructive/10 px-3.5 py-2.5 text-sm text-destructive">
                {deleteError}
              </div>
            )}
